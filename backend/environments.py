...
CONFIG_ROUTING_KEY = getenv("MAIN_SERVICE_ROUTING_KEY", "config")
RABBITMQ_USERNAME = getenv("RABBITMQ_USERNAME", "master")
RABBITMQ_PASSWORD = getenv("RABBITMQ_PASSWORD", "Bn5Vf6EskQBmXdB")
...
SWAGGER_URL = getenv("SWAGGER_URL","localhost:8000")
